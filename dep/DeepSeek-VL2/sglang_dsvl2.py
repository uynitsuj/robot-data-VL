"""
Usage:
python sglang_dsvl2.py --model-path deepseek-ai/deepseek-vl2-tiny
"""
...
def main(
    ...
    image2 = Image.open(requests.get("https://raw.githubusercontent.com/deepseek-ai/DeepSeek-VL2/refs/heads/main/images/visual_grounding_1.jpeg", stream=True).raw)
